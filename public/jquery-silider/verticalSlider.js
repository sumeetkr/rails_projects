    ...
    $.widget("mobile.slider", $.mobile.widget, {
        ...
        _create:function () {
            ...
            $.extend(this, {
                ...
                _popup:popup,
                _popupVisible:false,
                _handleText:handle.find(".ui-btn-text")
            });
...
//            newval = getDisplayText(newval);
            ...
            this.handle.attr({
                ...
                "aria-valuetext":getDisplayText(cType === "input" ? newval : control.find("option").eq(newval).getEncodedText()) ,
        ...
        _positionPopup:function () {
            ...
            this._popup.offset({
                left:dstOffset.left - 60 + ( this.handle.width() - this._popup.width() ) / 2,
                top:dstOffset.top + 32 - this._popup.outerHeight()
            });
        },
        ...
        _setOption:function (key, value) {
            ...
            if (key === "showValue") {
                if (value) {
                    this._handleText.html(getDisplayText( this._value())).show();
                } else {
        ...
        _refresh:function (newval) {
            ...
            this.slider.val(this._currentValue);

            if (o.popupEnabled) {
                this._positionPopup();
                this._popup.html(getDisplayText( newValue));
            }

            if (o.showValue) {
                this._handleText.html(getDisplayText(this._currentValue));
            }
        },
        ...
        _hidePopup:function () {
            ...
            //kludge, need to fix it
            if(redrawPolyline != null){
                redrawPolyline();
            };
        }
    ...
    function getDisplayText(val){
        ...
        minutes0 = parseInt(d.getMinutes());
        hours0 = parseInt(d.getHours());
