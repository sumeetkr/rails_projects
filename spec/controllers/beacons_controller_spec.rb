  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved beacon as @beacon" do
        ...
        post :create, {:beacon => { "identifier" => "invalid value" }}, valid_session
        assigns(:beacon).should be_a_new(Beacon)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested beacon" do
        ...
        Beacon.any_instance.should_receive(:update_attributes).with({ "identifier" => "MyString" })
        put :update, {:id => beacon.to_param, :beacon => { "identifier" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the beacon as @beacon" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Beacon.any_instance.stub(:save).and_return(false)
        put :update, {:id => beacon.to_param, :beacon => { "identifier" => "invalid value" }}, valid_session
        assigns(:beacon).should eq(beacon)
      end
